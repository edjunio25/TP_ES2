...
/*
        System.out.println("Cliente antes da adição:");
        System.out.println("ID: " + cliente.getId());
        System.out.println("Nome: " + cliente.getNome());
        System.out.println("CPF: " + cliente.getCpf());

        System.out.println("Cliente adicionado:");
        System.out.println("ID: " + clienteAdicionado.getId());
        System.out.println("Nome: " + clienteAdicionado.getNome());
        System.out.println("CPF: " + clienteAdicionado.getCpf());
*/
        verify(repositorioClientes, times(3)).adicionarCliente(any(Cliente.class));

        //Esse metodo estava comparando de forma errônea. ambos tinham atributos identicos, mas não eram os mesmos
        //Assertions.assertEquals(clienteAdicionado, cliente);

        assertEquals(cliente.getId(), clienteAdicionado.getId());
        assertEquals(cliente.getNome(), clienteAdicionado.getNome());
        assertEquals(cliente.getCpf(), clienteAdicionado.getCpf());
        assertEquals(cliente.getTelefone(), clienteAdicionado.getTelefone());
